...
export const resumes: Resume[] = [
    ...
    resume_stories: [
      {
        ...
        programLanguage:
          "React(TypeScript) / RTK / AntDesign / Appsync(Apollo) / Chart.js",
        resume: 1,
        desc: [
          "고객사 서비스 중",
      ...
      },
      {
        ...
        type: "complete",
        title:
          "국립농원과학원 봉군형성실 Web Console 개발(20.01 ~ 2020.06)",
        isDeveloperPosition: true,
      ...
      },
      {
        ...
        type: "complete",
        title:
          "국립농원과학원 봉군형성실 Mobile App 개발(20.03 ~ 20.06)",
        isDeveloperPosition: true,
    ...
    resume_stories: [
      {
        ...
        type: "complete",
        title:
          "알티캐스트 & KT 셋탑 키즈랜드 2.0 프로젝트(18.05 ~ 18.10)",
        isDeveloperPosition: true,
      ...
      },
      {
        ...
        type: "complete",
        title:
          "알티캐스트 & KT 셋탑 Voice UI 프로젝트(19.05 ~ 19.09)",
        isDeveloperPosition: true,
        programLanguage: "Javascript(es5)",
        resume: 2,
        desc: [
  ...
  },
  {
    ...
    resume_stories: [
      ...
      },
      {
        ...
        type: "complete",
        title:
          "경기도시공사 인터넷청약시스템 구축 프로젝트(17.12 ~ 18.04)",
        isDeveloperPosition: true,
        programLanguage: "Spring MVC / Ibatis / HTML & CSS & JQuery",
        resume: 3,
        desc: [
  ...
  },
  {
    ...
    usedRank: false,
    position:
      "JAVA 기반 웹표준/웹프로그래밍 개발자 양성과정(16.09 ~ 17.03)",
    rank: null,
    statusType: "complete",
    statusText: "수료",
    flow: 2,
    ...
    resume_stories: [
      {
        ...
        isDeveloperPosition: true,
        programLanguage:
          "Spring / MyBatis / Maria DB / HTML & CSS & JQuery",
        resume: 4,
        desc: [
          "응용 애플리케이션 개발과정 습득",
  ...
  },
  {
    ...
    resume_stories: [
      ...
      },
      {
        ...
        type: "complete",
        title:
          "삼성전자 Foundry 부문 비즈니스 시스템 구축 Phase 2 (22.06 ~ 23.08)",
        isDeveloperPosition: true,
        programLanguage: "Salesforce LWC / APEX",
        resume: 5,
        desc: [
      ...
      },
      {
        ...
        type: "complete",
        title:
          "삼성전자 반도체 부문 CRM(SalesForce)시스템 구축 Phase 1 (21.07 ~ 22.05)",
        isDeveloperPosition: true,
        programLanguage: "Salesforce LWC / APEX",
        resume: 5,
        desc: [
