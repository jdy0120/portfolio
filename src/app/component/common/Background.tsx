...
import COLOR from "@/app/core/colors";
...
const HeroBackground = (props: Props) => {
  ...
  const getPathColor = () => {
    switch (pathname.split("/")[1]) {
      case "about":
        return useDark
          ? COLOR.ABOUT_INK_BACK_COLOR_DARK
          : COLOR.ABOUT_INK_BACK_COLOR_LIGHT;
      case "portfolio":
        return useDark
          ? COLOR.FOLIO_INK_BACK_COLOR_DARK
          : COLOR.FOLIO_INK_BACK_COLOR_LIGHT;
      case "resume":
        return useDark
          ? COLOR.RESUME_INK_BACK_COLOR_DARK
          : COLOR.RESUME_INK_BACK_COLOR_LIGHT;
      case "blog":
        return useDark
          ? COLOR.BLOG_INK_BACK_COLOR_DARK
          : COLOR.BLOG_INK_BACK_COLOR_LIGHT;
      default:
